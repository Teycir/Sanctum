...
import { uploadVault, downloadVault, serializeVaultMetadata, deserializeVaultMetadata } from '../storage/vault';
...
import { CreateVaultParamsSchema, UnlockVaultParamsSchema } from '../validation/schemas';
